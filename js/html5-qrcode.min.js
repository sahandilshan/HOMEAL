function getLazarSoftScanner() {
    ...
    var u = new f(0, 1, "L"), d = new f(1, 0, "M"), l = new f(2, 3, "Q"), c = new f(3, 2, "H"),
        g = new Array(d, u, c, l);
    ...
    p.rsDecoder = new function (e) {
        this.field = e, this.decode = function (e, t) {
            ...
            if (!a) {
                var s = new C(this.field, r), h = this.runEuclideanAlgorithm(this.field.buildMonomial(t, 1), s, t),
                    w = h[0], f = h[1], u = this.findErrorLocations(w), d = this.findErrorMagnitudes(f, u, !1);
    ...
    A.imagedata = null, A.width = 0, A.height = 0, A.qrCodeSymbol = null, A.debug = !1, A.maxImgSize = 1048576, A.sizeOfDataLengthInfo = [[10, 9, 8, 8], [12, 11, 16, 10], [14, 13, 16, 12]], A.callback = null, A.vidSuccess = function (e) {
        ...
        if (0 == arguments.length) {
            if (A.canvas_qr2) var t = A.canvas_qr2,
                n = A.qrcontext2; else n = (t = document.getElementById("qr-canvas")).getContext("2d");
...
var Html5QrcodeScanner = function () {
    ...
    return _createClass(a, [{
        ...
        key: "__createSectionControlPanel", value: function () {
            ...
            g.setAttribute("style", "background-color:#EC7A23;color:#FFFFFF;text-shadow: none !important");
        ...
        key: "__createSectionSwap", value: function () {
            ...
            f.style.textAlign = "center";
            var g = document.createElement("a");g.style.color="#EC7A23"
            g.style.textDecoration = "underline", g.id = this.__getDashboardSectionSwapLinkId(), g.innerHTML = this.currentScanType == a.SCAN_TYPE_CAMERA ? c : d, g.href = "#scan-using-file", g.addEventListener("click", function (e) { e.preventDefault()
